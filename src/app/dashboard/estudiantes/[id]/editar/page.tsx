  ...
  return (
    <div className="h-full flex flex-col p-8 pt-4 max-w-6xl mx-auto w-full">
      <div className="mb-8 shrink-0">
        <h2 className="text-3xl font-extrabold text-blue-900 tracking-tight">Editar Estudiante</h2>
        <p className="text-slate-500 mt-1">Modifique los datos del estudiante seleccionado.</p>
      </div>
