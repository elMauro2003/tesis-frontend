    ...
    <div className="bg-background text-on-surface min-h-screen font-body w-full">
      ...
      <aside className="fixed left-4 top-4 bottom-4 w-64 rounded-xl bg-surface-container-lowest shadow-[0_20px_40px_rgba(0,55,176,0.06)] flex flex-col h-[calc(100vh-2rem)] p-4 z-50">
        <div className="flex items-center gap-3 mb-8 px-2">
          ...
          <div>
            <h1 className="font-headline font-extrabold text-primary-container leading-none">Residencias</h1>
        ...
        <nav className="flex-1 space-y-1">
          ...
          <Link href="/dashboard" className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-surface-container-low text-primary border-l-4 border-primary transition-all group">
