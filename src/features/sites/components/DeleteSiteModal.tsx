      ...
      <div className="overflow-hidden rounded-2xl bg-[var(--color-surface-container-lowest)] shadow-[var(--shadow-ambient)]">
        <div className="bg-red-50 p-6 flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-xl font-extrabold text-red-900 leading-tight">Eliminar Sede</h3>
            <p className="mt-1 text-xs text-[var(--color-on-surface-variant)]">Esta acción puede afectar la organización de edificios asociados.</p>
          </div>
        ...
        <div className="p-6 space-y-4">
          ...
          <p className="text-sm text-[var(--color-on-surface-variant)] leading-relaxed">
            Si continúa, la sede quedará eliminada del catálogo institucional. Use esta acción solo cuando haya confirmado que no existen dependencias activas.
          </p>
        </div>
        ...
        <footer className="border-t border-[var(--color-outline-variant)]/15 p-6 flex justify-end items-center gap-3 bg-[var(--color-surface-container-lowest)]">
          ...
          <button
            ...
            className="px-6 py-2.5 rounded-lg text-sm font-semibold text-white bg-red-600 shadow-[0_14px_24px_rgba(186,26,26,0.18)] hover:bg-red-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
          >
